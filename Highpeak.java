    ...
    static int findelements(int res,int array[],int N,int M)
    {
        ...
        return 0;
          ...
          public static void main(String[] args) {
            ...
            String items[]={"MI Band: 999",
            "Sandwich toster: 2195",
              "Cult pass:2799","Scale: 4999",
              "Fitbit pius: 7980",
              "Microwave Oven: 9800",
            " Alexa:9999","Digital Camera:11101","Ipods:22349",
            "Mackbook pro:229900"};
            ...
            System.out.println("Here the goodie that are selected for distribution are:");

            for (int i=startindex;i<startindex+M;i++)
            System.out.println(items[i]);
            System.out.println("\n");
            System.out.println("And the differance between the chosen goodies with highest price and the lowest price is:"+result);
          }
    }
